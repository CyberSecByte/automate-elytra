...
async def build(event):
    ...
    os.system(f"echo launchlunch.sh {valueone} {valuetwo} > ../elytra/build/pastelunch.sh")
    ...
    os.system(f"echo launchbrunch.sh {valueone} {valuetwo} > ../elytra/build/pastebrunch.sh")
    i = open("../elytra/build/pastebrunch.txt", "r")
